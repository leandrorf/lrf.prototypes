...
public interface IOAuthService
{
    ...
    Task<(User User, Client Client)?> ConsumeAuthorizationCodeAsync(string code, string redirectUri, string clientId, string? codeVerifier, CancellationToken cancellationToken = default);
}
